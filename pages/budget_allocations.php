              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="amount" id="amount" placeholder="Enter amount" inputmode="decimal" 
                    onkeyup="formatCurrency(this)"  onblur="formatCurrency(this, true)" onfocus="this.select()"
                    required>                  
                  </div>
                </div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="amount" id="edit_amount" placeholder="Enter amount" 
                    inputmode="decimal" 
                    onblur="formatCurrency(this, true)" 
                    onfocus="this.select()"
                    required>
                  </div>
                  <div class="form-group">
...
<script>
  ...
  $(document).ready(function () {
    ...
    $('#datatable').on('click', '.edit-allocation', function () {
      ...
      $editAmountInput.val(allocated_amount); 
