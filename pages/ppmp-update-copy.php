...
<script>
  ...
  function loadExistingItems(items) {
    ...
    items.forEach((item, index) => {
        ...
        const newRow = `
            <tr data-item-id="${item.item_id}" data-type="existing">
                ...
                <td class="text-center">
                    <button type="button" class="btn btn-info btn-sm edit-item-btn" data-item='${itemData}' data-id="${item.item_id}" title="Edit Item">
  ...
  $(document).ready(function () {
    ...
    $(document).on('click', '.edit-item-btn', function() {
      ...
      $('#SaveForm').prepend(`<input type="hidden" name="item_id_to_edit" id="item_id_to_edit" value="${itemData.item_id}">`);
